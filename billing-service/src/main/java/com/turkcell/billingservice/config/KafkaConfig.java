...
public class KafkaConfig {
    ...
    public NewTopic billCreatedTopic() {
        return TopicBuilder.name("bill-created")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic billStatusUpdatedTopic() {
        return TopicBuilder.name("bill-status-updated")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic billOverdueTopic() {
        return TopicBuilder.name("bill-overdue")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic paymentReminderTopic() {
        return TopicBuilder.name("payment-reminder")
                .partitions(1)
                .replicas(1)
                .build();
    }
